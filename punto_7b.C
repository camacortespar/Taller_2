...
void punto_7b(){
  ...
  TH1F *hist_track_response20 = new TH1F("","Truth p_{T}>20 GeV;Track p_{T}/Truth p_{T}; Events",20,0,2);
  TH1F *hist_track_response100 = new TH1F("","Truth p_{T}>100 GeV;Track p_{T}; Events",20,0,2);
  TH1F *hist_track_response500 = new TH1F("","Truth p_{T}>500 GeV;Track p_{T}; Events",20,0,2);
  ...
  for (i = 0; i < nentries; i++)
	...
	if(truth_R4_pt->size()!=0 && truth_R4_pt->at(0)>20000.){
	  ...
	  if(fabs(truthJet.DeltaR(trackJet))<0.3){
	    hist_track_response20->Fill(track_R4_pt->at(0)/truth_R4_pt->at(0),evtw);
	  }
	}
	if(truth_R4_pt->size()!=0 && truth_R4_pt->at(0)>100000.){
	  ...
	  truthJet.SetPtEtaPhiM(truth_R4_pt->at(0),truth_R4_eta->at(0),truth_R4_phi->at(0),truth_R4_m->at(0));
	  if(fabs(truthJet.DeltaR(trackJet))<0.3){
	    hist_track_response100->Fill(track_R4_pt->at(0)/truth_R4_pt->at(0),evtw);
	  }
	}
	if(truth_R4_pt->size()!=0 && truth_R4_pt->at(0)>500000.){
	  ...
	  truthJet.SetPtEtaPhiM(truth_R4_pt->at(0),truth_R4_eta->at(0),truth_R4_phi->at(0),truth_R4_m->at(0));
	  if(fabs(truthJet.DeltaR(trackJet))<0.3){
	    hist_track_response500->Fill(track_R4_pt->at(0)/truth_R4_pt->at(0),evtw);
	  }
	}
      }
    }
  ...
  // Let's plot
  hist_track_response20->SetMarkerStyle(20);
  hist_track_response20->SetMarkerColor(2);
  hist_track_response20->Draw("");
  hist_track_response100->SetMarkerStyle(21);
  hist_track_response100->SetMarkerColor(38);
  hist_track_response100->Draw("same");
  hist_track_response500->SetMarkerStyle(22);
  hist_track_response500->SetMarkerColor(8);
  hist_track_response500->Draw("same");
  //canvas->SetLogy();
  canvas->BuildLegend();
  canvas->Draw();
